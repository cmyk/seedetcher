...
func DefineFlags() *Flags {
	...
	flag.StringVar(&f.WalletType, "w", "multisig", "Wallet type (seed-12, seed-15, seed-18, seed-21, singlesig, singlesig-longwords, multisig, multisig-mainnet-2of3, multisig-2of4, multisig-3of5, or multisig-7of10)")
